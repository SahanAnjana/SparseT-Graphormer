...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler):
    if hasattr(args, 'sweep_output_dir'):
        save_dir = args.sweep_output_dir
    else:
...
def get_last_checkpoint(args):
    ...
    """
    d = args.sweep_output_dir if 'sweep_output_dir' in args else args.output_dir
...
def load_model(args, model_without_ddp, optimizer, loss_scaler):
    ...
    if args.resume:
        ...
        output_dir = getattr(args, 'sweep_output_dir', args.output_dir)
